...
# Parameters — Borehole 1 of Lamarche (2021), Table 1 (diameters are converted into radii)
...
ks  = 2.5               # Ground thermal conductivity [W/mK]
...
println(rpad("V [m³/s]", 12), " ", rpad("Re_ann", 10), " ", rpad("Re_in", 10), " ",
        rpad("R12", 8), " ", rpad("R1", 8), " ", "Rbe")
for V in [25, 50, 75, 100, 150, 200] .* 1e-6
    ...
    println(rpad(string(round(V, digits=2)), 12), " ",
